...
using namespace std;
struct Student {
   string courseName[5]={"IPL"," IPL Lab ","Phy","Phy Lab", "Math"};
   float marks[5]={0,0,0,0,0};
   float credit[5]={3,1,3,1,3};
   float grade[5];
   float Count=0;
   float totalCredit=0;
   float cgpa=0;
...
int main() {
   struct Student s;
   //Mark's..Ipl ..D..58,Ipl Lab..D+..63,Phy..D+..60,Phy lab..A..85,Math..D..58..
